...
4. 代表者が4問にYes / Noで回答します。Yesは左、Noは右へ進みます。
5. 到達後に予測者名を公開し、正解者へ1点を加算します。全員が一度ずつ代表者を務めると終了します。

ゲーム中に参加したユーザーは現在のラウンドを観戦し、次のラウンドから予測へ参加します。代表者キューの末尾にも追加されます。最終結果では、代表者と予測者の成功マトリクス、および各代表者が回答した4問とYes / Noの履歴を確認できます。
